...
5. Створіть службу електронної пошти (використовуючи [SendGrid](https://www.twilio.com/en-us/products/email-api) або аналогічну службу) та надішліть електронного листа на адресу електронної пошти користувача після створення bet
